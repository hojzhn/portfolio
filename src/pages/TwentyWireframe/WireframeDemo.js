...
function MobileBlocker() {
  return (
    <div className="fixed inset-0 z-[1000] hidden max-md:flex items-center justify-center bg-[var(--bg)] p-8">
      <div className="max-w-[320px] flex flex-col items-center gap-4 text-center">
        <i
          className="fa-regular fa-display text-[var(--point)] text-[28px]"
          aria-hidden="true"
        />
        <div className="font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--point)]">
          Desktop only
        </div>
        <h1 className="m-0 text-[20px] font-medium text-[var(--txt)] leading-tight">
          Sorry, this test is not available on small screens.
        </h1>
        <p className="m-0 text-[13px] text-[var(--txt2)] leading-[1.55]">
  ...
  return (
    <ChipClickContext.Provider value={navigate}>
      ...
      >
        ...
        >
          {!view && <h1 style={{ marginBottom: 16, flexShrink: 0 }}>Inbox</h1>}
