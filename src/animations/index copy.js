...
export const preLoaderAnim = (design, setLayout, options = {}) => {
  ...
  tl.to("body", {
    ...
    .to(".main-l", {
      duration: 0.5,
      css: { background: "transparent", border: "1px solid" },
    })
...
export const menuAnim = (orientation, design, isOpen, options = {}) => {
  ...
  if (isOpen) {
    ...
    if (orientation === "portrait") {
      ...
      tl.set(".main-r", { width: "0px", height: "100%", flex: "auto" });
      ...
      tl.set(".main-r", { width: "100%", height: "0px", flex: "none" });
...
export const orientationAnim = (design, orientation) => {
