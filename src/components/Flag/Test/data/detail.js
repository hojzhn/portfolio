export const DETAIL = {
  ...
  // Fallback shared composition. Per-basket topHoldings and sectors live in
  // catalog.js and should be preferred when available.
  holdings: [
  ...
  risk: {
    ...
    volatility1Y: { low: 0.15, high: 0.22, note: "modeled on similar growth themes." },
  ...
  fees: {
    expenseRatio: 0.0085,
    managementFee: 0.0066,
    distributionFee: 0.001,
    otherCosts: 0.0009,
    categoryAvgExpenseRatio: 0.0095,
    tenYearCostOn10kUSD: 850,
  },

  keySensitivities: [
    { name: "Macro tightening", note: "Higher rates and tighter liquidity may compress thematic valuations." },
    { name: "Concentration risk", note: "A small number of holdings can drive a large share of returns." },
    { name: "Demand cycle", note: "Slower end-market growth dampens revenue expectations across the basket." },
    { name: "Regulatory action", note: "Policy changes affecting the underlying theme can impact pricing." },
  ],
  ...
  amount: {
    ...
    // Used by Traditional Basket flow only.
    accountTypes: [
      { id: "individual", label: "Individual Taxable" },
      { id: "joint", label: "Joint Taxable" },
      { id: "traditional-ira", label: "Traditional IRA" },
      { id: "roth-ira", label: "Roth IRA" },
      { id: "rollover", label: "Rollover IRA" },
    ],
    defaultAccount: "individual",
  },

  disclosure: {
    bullets: [
      "The value of investments can go down as well as up. Past performance is not a reliable indicator of future results.",
      "Thematic baskets carry concentration risk. A small number of holdings or sectors can drive a large share of return and volatility.",
      "Fees are subject to change with prior notice. Total expense ratio includes management fee, custody, and trading costs.",
      "Holdings are reviewed and rebalanced quarterly per the basket's mandate. The platform does not provide individualized investment advice.",
    ],
    shortNote:
